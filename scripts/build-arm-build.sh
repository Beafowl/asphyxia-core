...
echo "Packing arm64"
npx @yao-pkg/pkg ./build-env -t node22-linux-arm64 -o ./build/asphyxia-core-arm64 --options "no-warnings,experimental-sqlite"

echo "Packing armv7"
npx @yao-pkg/pkg ./build-env -t node22-linux-armv7 -o ./build/asphyxia-core-armv7 --options "no-warnings,experimental-sqlite" || \
